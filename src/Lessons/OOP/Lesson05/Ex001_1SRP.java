...
public class Ex001_1SRP {
    public static void main(String[] args) {
        Planner verngerPlanner = new Planner();
        verngerPlanner.addEntry("1");
        verngerPlanner.removeEntry(0);
        verngerPlanner.saveAllText("path");
        verngerPlanner.loadFromDB("10.0.0.0", "admin", "1234");
    }
}
