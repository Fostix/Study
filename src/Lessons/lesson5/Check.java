...
public class Check {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Постфиксная запись:" + infixToPostfix(exp));
        System.out.println("Результат вычисления:" + calculate(exp));
        System.out.println();
