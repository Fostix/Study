...
public class Ex {
    public static void main(String[] args) {
        ...
        List<Integer> availableDivider = findAvailableDivider(10);
        List<Integer> simpleNumber = findSimpleNumber(10);
    ...
    public static List<Integer> findAvailableDivider(int number) {
        ...
        System.out.println("Counter available: " + counter);
        return result;
    }
    ...
    public static List<Integer> findSimpleNumber(int max) {
        ...
        System.out.println("Counter simplezzzzzz: " + counter);
        return result;
    }
